...
| **Data Analysis Projects**       | Exploratory Data Analysis (EDA) of the Netflix, Ecommerce site, Spotify and etc., using Python.| Python, Pandas, Matplotlib, Google Colab/ Jupyter Notebook      | https://github.com/GiftaGrace/Data-Analysis-Projects |
